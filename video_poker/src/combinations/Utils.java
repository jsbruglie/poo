...
/**
 * Generic utilities used by several rules
 */
public class Utils {
	 ...
	 * @return A list with all of the cards in the input array
	 */
	...
	/**	
	 * Checks if all of the cards in a list have the same suit
	 * @param l The list of cards to be evaluated
	 * @return Whether the cards in the list have the same suit
	 */
	public static boolean allSameSuit(List<Card> l){
		
		if (l != null){
			Suit suit = l.get(0).suit;
			for (int i = 1; i < l.size(); i++){
				 if (l.get(i).suit != suit)
					 return false;
			}
			return true;
		}
	 ...
	 * @param rank_occurrences Array with rank occurrences
